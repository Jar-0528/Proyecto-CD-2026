...
This data package contains the data that powers the chart ["Unemployment rate"](https://ourworldindata.org/grapher/unemployment-rate?v=1&csvType=full&useColumnShortNames=false) on the Our World in Data website. It was downloaded on April 11, 2026.
...
## Unemployment rate
Share of the [labor force](#dod:labor-force) without work, but actively looking for a job and available to start soon.
...
#### Full citation
ILO Modelled Estimates, via World Bank (2026) – processed by Our World in Data. “Unemployment rate – ILO” [dataset]. ILO Modelled Estimates, via World Bank, “World Development Indicators 125” [original data].
